...
public class SubModel {
	...
	public void checkAndSetStart() {
		...
		if(hasNoStart()) {	
			System.out.println("	has not start");
			...
			for(ComponentConfig comp: components) {
				System.out.println("	in comp "+comp.getId());
	...
	public int traverseModel(int visited, ComponentConfig comp) {
		visited++;
		System.out.println(visited + " " + components.size());
