...
public class TestRunWithPools {
	...
	public static void main(String[] args) {
		...
		try {
			int N = 20;
			int connectNo = 2;
			String modelStr = "model1";
			//FileReader fileReader = new FileReader(new File("input/arch-"+N+"-"+connectNo+".txt"));
			FileReader fileReader = new FileReader(new File("input/system/system-sub"+modelStr+".txt"));//new FileReader(new File("input/erp-model.txt"));
			 reader = new BufferedReader(fileReader);
			writer = new BufferedWriter(new FileWriter("result/system/"+modelStr+".csv", true));
