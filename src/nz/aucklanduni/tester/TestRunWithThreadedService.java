...
public class TestRunWithThreadedService {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String modelStr = "model8";
			//FileReader fileReader = new FileReader(new File("input/system/system-sub"+modelStr+".txt"));
			 reader = new BufferedReader(fileReader);
		   writer = new BufferedWriter(new FileWriter("result/result-erpmodel.csv", true));
			// writer = new BufferedWriter(new FileWriter("result/system/"+(isSync?"sync/":"async/")+modelStr+".csv", false));
